/* 都道府県道の路線を名指すキー。路線番号は県の中でしか一意でなく(県道 18 号は
 * 47 本あります)、キーは(県, 番号)の組を `nagano-18` の文字列にしたものです。
 * 番号だけでは 47 本のどれの話か分かりません。
 */
...
/* 打たれた番号で全国から探します。当て方は国道の一覧と同じ前方一致で、同じ欄が
 * 両方の系統に当たるので二つに分かれてはなりません。 */
