 ...
 * アイコンは、カードが横長で描く場面を正方形に切り出した物である。三枚の標識が
 * 道の上に立ち、路線が合流するほど道の色が深くなる。本物の `shield()` を
 * 使うので、番号入りの標識の見た目に二つの答えは生まれない。
 *
 ...
 *
 * 見るのは形だけで、書けるかどうかは見ない。権限で弾かれる書き先は描き終えて
 * から落ちる。実際に書いてみるほかなく、書いてしまえば確かめる意味が無い。 */
