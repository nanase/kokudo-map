...
// 出典を定義する唯一の場所。操作面も同じことを書いていたが、二箇所にあると片方
// が古くなる。必ず置くのは地図自身の部品のほうである。「国道マップについて」が
// 出典を繰り返さないのも同じ理由である。
map.addControl(
...
async function boot() {
   ...
   * 操作面に都道府県道の節は無いので(#109)、絞っていることを示す場所も解除する
   * ボタンもこのパネルのほかに無い。開かずに出すと、県道が 1 本しか出ていない
